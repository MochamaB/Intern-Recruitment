...
namespace Workflows.Controllers
{
    ...
    public class DocumentTypesController : Controller
    {
        ...
        public DocumentTypesController(WorkflowsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,DocumentName,MimeType,CreatedAt,UpdatedAt")] DocumentType documentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DocumentName,MimeType,CreatedAt,UpdatedAt")] DocumentType documentType)
        {
